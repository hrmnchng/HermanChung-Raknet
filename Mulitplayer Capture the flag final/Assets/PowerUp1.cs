...
public class PowerUp1 : NetworkBehaviour {
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if (m_state == State.Available) {
			...
			GameObject.Find ("CTFGameManager").GetComponent<CTFGameManager>().powerup1present = false;
			GameObject.Find ("CTFGameManager").GetComponent<CTFGameManager> ().SpawnPowerUp1 ();
		}
	}
